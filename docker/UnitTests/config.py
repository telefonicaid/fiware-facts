...
cfg_defaults = {
    ...
    'redisHost':    'redis',            # host of Redis
    'redisQueue':   'policymanager',        # name of the queue in redis
    'rabbitMQ':     'rabbit',            # IP of the RabbitMQ server
    'cloto':        'fiwarecloto',            # IP of fiware-cloto component
    'clotoVersion': 'v1.0',                 # Cloto API version
...
cfg_mysql_defaults = {
    'host':   'mysql',                   # host of Cloto Mysql database
    'charset':    'utf8',                   # charset of the data base
    'user':    'mysql',                   # user of cloto database
